...
import BENTOJson from '../clean_build/contracts/BENTODelegator.json';
import BENTORebaserJson from '../clean_build/contracts/BENTORebaser.json';
import BENTOReservesJson from '../clean_build/contracts/BENTOReserves.json';
import BENTOGovJson from '../clean_build/contracts/GovernorAlpha.json';
import BENTOTimelockJson from '../clean_build/contracts/Timelock.json';
...
import CRVPoolJson from '../clean_build/contracts/BENTOCRVPool.json';
import LINKPoolJson from '../clean_build/contracts/BENTOLINKPool.json';
import SNXPoolJson from '../clean_build/contracts/BENTOSNXPool.json';

// uniswap pool
import IncJson from '../clean_build/contracts/BENTOIncentivizer.json';
...
export class Contracts {
  constructor(
    ...
    this.rebaser = new this.web3.eth.Contract(BENTORebaserJson.abi);
    this.reserves = new this.web3.eth.Contract(BENTOReservesJson.abi);
    this.gov = new this.web3.eth.Contract(BENTOGovJson.abi);
    this.timelock = new this.web3.eth.Contract(BENTOTimelockJson.abi);
  ...
  setProvider(
    ...
    this.bento.setProvider(provider);
    ...
    const contracts = [
      { contract: this.bento, json: BENTOJson },
      { contract: this.rebaser, json: BENTORebaserJson },
      { contract: this.reserves, json: BENTOReservesJson },
      { contract: this.gov, json: BENTOGovJson },
