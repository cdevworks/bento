...
import "./BENTODelegate.sol";

contract BENTODelegator is BENTOTokenInterface, BENTODelegatorInterface {
    /**
     * @notice Construct a new BENTO
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "BENTODelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"BENTODelegator:fallback: cannot send value to fallback");
